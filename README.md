...
## Parte 1: Busqueda y Recuperación de Información
...
En este proyecto, nos centramos en dos tipos de datos multimedia: texto y audio. Utilizando algoritmos eficientes y estructuras de datos avanzadas, hemos desarrollado un sistema capaz de realizar búsquedas rápidas y precisas en una colección de documentos y archivos de audio. Aquí detallamos las técnicas y metodologías implementadas.
...
<details>
<summary>Preprocesamiento</summary>
<p>
...
<details>
<summary>Construcción del Índice</summary>
<p>
...
<details>
<summary>Experimentación</summary>
<p>
...
## Parte 2: Construcción del Índice Multidimensional

<details>
<summary>Índice Multidimensional</summary>
<p>
...
class KNN_HighD:
    constructor(num_bits, collection):
        ...
        index = create_faiss_index(dimension, num_bits)
...
#### 3. KNN_Sequential
La técnica KNN_Sequential es una implementación directa y optimizada del algoritmo K-Nearest Neighbors utilizando un heap para mantener los k vecinos más cercanos. Este enfoque es sencillo pero eficaz para pequeñas colecciones de datos.

**Implementación:**

```pseudo
class DistanceNode:
    constructor(distance, track_id):
    ...
    method __repr__():
        return (this.track_id, this.distance)
...
class OptimizedHeap:
    ...
    method push(node):
        heapq.heappush(this.heap, node)

    method pop():
        return heapq.heappop(this.heap)

    method replace_top(node):
        heapq.heapreplace(this.heap, node)
    ...
    method heapsort():
        return sorted(this.heap, key=lambda x: x.distance)
...
<details>
<summary>Experimentacion</summary>
<p>
...
<details>
<summary>Frontend Final</summary>
<p>
